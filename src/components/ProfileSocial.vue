...
<template>
    <div class="photoSocialContainer">
      <img src="/images/headshot.webp" :class="store.dark ? 'headshotDark' : 'headshotLight'" alt="headshot">
      <ul class="socialBar">
        <li>
        ...
        <li>
          <a href="https://twitter.com/adamryan1983" target="_blank">
        ...
        <li>
          <a href="https://github.com/adamryan1983" target="_blank">
        ...
        <li>
          <a href="https://linkedin.com/in/adamryan1983" target="_blank">
